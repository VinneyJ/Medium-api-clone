class ArticleReadTimeEngine:
    ...
    def __init__(self, article):
        ...
        self.banner_image_adjustment_time = round (1 / 6, 3) #17%
    ...
    def get_tags(self):
        tag_words = []
        [tag_words.extend(tag_word.spilt()) for tag_word in self.article.list_of_tags]
        return tag_words
    def get_body(self):
    ...
    def get_read_time(self):
        ...
        if word_length:
            ...
            if time_to_read < 1:
                ...
                read_time = (
                    str(round(time_to_read + self.banner_image_adjustment_time)) + " minute(s)"
                )
            return read_time
